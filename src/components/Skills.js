...
const Skills = () => {
  return (
    <>
      <h2 className='font-bold text-5xl mt-52 md:mt-40 w-full text-center sm:text-4xl mb-5'>
        Skills
      </h2>
      <div className='w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] lg:bg-circularLightLg md:bg-circularLightMd sm:bg-circularLightSm md:mb-24'>
        <motion.div
        ...
        <Skill skill='AWS' x='15vw' y='30vw' />
        <Skill skill='Swift' x='34vw' y='7vw' />
        <Skill skill='Python' x='-35vw' y='6vw' />
        <Skill skill='Docker' x='20vw' y='-30vw' />
        <Skill skill='OpenAI' x='-23vw' y='-30vw' />
        <Skill skill='Supabase' x='38vw' y='-23vw' />
        <Skill skill='Electron' x='38vw' y='24vw' />
        <Skill skill='Drizzle' x='-38vw' y='-12vw' />
        <Skill skill='SingleStore' x='-38vw' y='30vw' />
      </div>
    </>
  );
};
