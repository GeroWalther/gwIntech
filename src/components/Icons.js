...
export const FullStackCircularLogo = ({ className, ...rest }) => (
  // The ring used to be a single outlined <path> — the letters were vector
  // shapes, so the "Fulll-Stack" typo in it could not be edited. It is real
  // text on a circular path now, which fixes the spelling and means the
  // wording can just be changed here in future.
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={1080}
    height={1080}
    ...
    <defs>
      <path
        id='gw-circular-logo-path'
        fill='none'
        d='M405 405 m-186 0 a186 186 0 1 1 372 0 a186 186 0 1 1 -372 0'
      />
    </defs>
    <text
      fontSize={46}
      ...
      letterSpacing={0.5}
      textAnchor='middle'>
      <textPath href='#gw-circular-logo-path' startOffset='50%'>
...
//Skills Logos
export const ApolloLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    ...
    <path fill='none' d='M908.6 289.6H-64V-42h972.6z' />
  </svg>
);
export const PrismaLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    fill='currentColor'
...
export const ReactLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={500}
    height={500}
...
export const ReactNativeLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={500}
    height={500}
...
export const ReactQueryLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
...
export const ReduxLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    viewBox='0 0 100 100'
    className={`w-full h-auto ${className}`}
...
export const SassLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    viewBox='20 -10 80 80'
    width={110}
...
export const TWCSS = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={500}
    height={500}
...
export const ZodLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    ...
    />
    <use xlinkHref='#b' width={1045} height={842} x={30} y={160} />
    <path
...
export const TSLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    viewBox='0 0 400 400'
    className={`w-full h-auto ${className}`}
...
export const PlanetScaleLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    preserveAspectRatio='xMidYMid'
    viewBox='0 0 256 256'
    ...
    <path d='M256 128.044c-.024 70.657-57.299 127.932-127.956 127.956ZM128 0c51.977 0 96.719 30.98 116.765 75.483L75.483 244.765a127.791 127.791 0 0 1-20.636-11.715L159.897 128H128l-90.51 90.51C14.327 195.345 0 163.345 0 128 0 57.308 57.308 0 128 0Z' />
  </svg>
);
export const CSSLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={500}
    height={500}
...
export const GQLLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={300}
    height={300}
...
export const NodeLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
...
export const NextLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={500}
    height={500}
...
export const HTMLLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    height={500}
    width={500}
...
export const JSLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
...
export const TRPCLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    fill='none'
    viewBox='0 0 560 560'
...
export const MongoDBLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={500}
    height={500}
...
export const SwiftLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={64}
    height={64}
...
export const DockerLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    viewBox='0 0 640 512'
    className={`w-full h-auto ${className}`}
...
export const AWSLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
...
export const OpenAILogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={800}
    height={800}
...
export const PythonLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    viewBox='0 0 32 32'
    className={`w-full h-auto ${className}`}
...
export const SupabaseLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    viewBox='0 0 24 24'
    className={`w-full h-auto ${className}`}
...
export const DrizzleLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={54}
    height={54}
...
export const ElectronLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={64}
    height={64}
    ...
    <path d='M6.584 52.783a4.105 4.105 0 0 0 0-8.21 4.1 4.1 0 1 0 .001 8.21zm0-1.715a2.39 2.39 0 0 1-2.389-2.389 2.39 2.39 0 0 1 2.389-2.389 2.39 2.39 0 0 1 2.389 2.389 2.39 2.39 0 0 1-2.389 2.389zM32.03 8.2c2.267 0 4.105-1.838 4.105-4.105S34.296 0 32.03 0s-4.105 1.838-4.105 4.105S29.763 8.2 32.03 8.2zm0-1.715a2.39 2.39 0 0 1-2.389-2.389 2.39 2.39 0 0 1 2.389-2.389 2.39 2.39 0 0 1 2.389 2.389 2.39 2.39 0 0 1-2.389 2.389zm.626 30.04a2.97 2.97 0 1 1-1.254-5.806 2.97 2.97 0 1 1 1.254 5.806z' />
  </svg>
);
export const SingleStoreLogo = ({ className, ...rest }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={486}
    height={101}
    ...
    <path
      fill='#000'
      d='M123.495 60.72v-.347h7.033v.346c0 5.364 3.063 9.47 12.397 9.47h.696c7.174 0 11.074-3.063 11.074-7.66v-.346c0-4.317-2.507-6.197-6.894-7.244l-11.143-2.716c-6.757-1.67-11.35-5.364-11.35-12.674v-.696c0-8.077 6.407-13.44 17.41-13.44h.697c10.793 0 16.993 5.85 16.993 13.856v.347h-6.893v-.347c0-4.11-3.274-8.076-10.097-8.076h-.697c-6.963 0-10.653 3.203-10.653 7.73v.346c0 3.69 2.16 5.85 6.963 7.034l11.214 2.716c6.823 1.67 11.213 5.154 11.213 12.604v.696c0 8.357-6.477 13.65-17.897 13.65h-.696c-14.137 0-19.36-6.266-19.36-15.25h-.01ZM166.875 25.97h6.546v7.243h-6.546v-7.244Zm0 13.926h6.546v35.517h-6.546V39.896ZM179.681 39.9h6.267v5.71c3.133-4.667 5.85-6.127 10.863-6.127h.697c7.313 0 11.49 3.83 11.49 12.813v23.12h-6.547V53.199c0-6.126-2.296-8.566-6.756-8.566h-.697c-5.57 0-8.773 4.246-8.773 10.376v20.404h-6.547V39.896l.003.003ZM214.285 78.063h6.546v.346c0 3.274 3.064 4.737 8.844 4.737h.28c5.293 0 8.636-1.603 8.636-6.407v-8.076c-2.716 4.11-5.223 5.64-10.236 5.64h-.697c-8.773 0-14.067-6.757-14.067-17.06v-.697c0-10.307 5.294-17.06 13.997-17.06h.697c5.223 0 7.8 1.463 10.516 6.06v-5.64h6.267v36.84c0 8.077-5.78 11.28-15.39 11.28h-.28c-11.56 0-15.113-4.317-15.113-9.61v-.353Zm15.113-8.847h.697c5.92 0 8.913-3.9 8.913-11.977v-.696c0-8.077-2.993-11.977-8.913-11.977h-.697c-5.71 0-8.913 3.97-8.913 11.977v.696c0 8.007 3.203 11.977 8.913 11.977ZM251.328 25.97h6.547v49.443h-6.547V25.969ZM263.298 58.003v-.697c0-11.42 5.64-17.827 15.807-17.827h.696c9.61 0 14.834 5.57 14.834 17.2 0 1.114-.07 1.95-.14 2.507h-24.514c.21 7.87 3.414 11.77 9.124 11.77h.696c6.197 0 7.52-3.97 7.52-5.99v-.347h6.617v.347c0 4.387-2.993 10.863-13.927 10.863h-.696c-10.517 0-16.017-6.406-16.017-17.826Zm24.653-3.69v-.14c0-6.964-3.063-9.89-8.216-9.89h-.697c-4.943 0-8.497 3.203-8.983 10.026h17.896v.004ZM299.228 60.72v-.347h7.033v.346c0 5.364 3.064 9.47 12.397 9.47h.697c7.173 0 11.073-3.063 11.073-7.66v-.346c0-4.317-2.507-6.197-6.893-7.244l-11.144-2.716c-6.756-1.67-11.35-5.364-11.35-12.674v-.696c0-8.077 6.407-13.44 17.41-13.44h.697c10.793 0 16.993 5.85 16.993 13.856v.347h-6.893v-.347c0-4.
.08-.143.157-.217.237l20.707 19.13c.847-.91 1.66-1.857 2.44-2.837l-18.13-16.75v-.003ZM81.547 90.476 66.987 68.41c-.576.296-1.16.576-1.753.843 0 0-1.07.46-1.313.56l14.903 22.583c.93-.61 1.837-1.25 2.727-1.92h-.004ZM61.447 70.7c-.246.076-1.81.53-2.273.643 0 0-.437.107-.557.133l9.35 26.297a50.19 50.19 0 0 0 2.73-1.057l-9.25-26.02v.004ZM55.828 71.976c-.82.177-1.65.304-2.49.387l2.813 28.05a51.56 51.56 0 0 0 2.496-.31l-2.82-28.123v-.004ZM50.124 72.436c-.7-.036-1.4-.103-2.1-.206l-3.983 27.91c.696.1 1.396.186 2.093.26l3.99-27.96v-.004ZM17.267 54.576a35.298 35.298 0 0 1 1.544-4.306l10.37.216c0-.21 0-.416.006-.626l-28.186-.59a49.353 49.353 0 0 0 .136 4.97l16.134.336h-.004ZM39.03 99.146l.284-.703a36.175 36.175 0 0 1-4.533-2.073l10.03-24.864c-.61-.186-1.22-.403-1.824-.646-.03-.014-.06-.024-.086-.037l-10.544 26.14c.03.013.06.023.087.037a50.578 50.578 0 0 0 6.587 2.146ZM28.944 92.416a36.502 36.502 0 0 1-3.55-3.373l14.31-19.833c-.5-.307-.986-.63-1.453-.97L21.754 91.1a50 50 0 0 0 5.604 3.513l1.586-2.2v.003ZM21.37 83.77a36.172 36.172 0 0 1-2.286-4.254l16.26-13.81c-.34-.353-.666-.716-.983-1.093l-21.487 18.25a50.3 50.3 0 0 0 4.287 4.48l4.206-3.573h.004ZM9.1 77.77l7.958-3.967a36.105 36.105 0 0 1-.904-4.683l15.86-7.907a22.61 22.61 0 0 1-.553-1.05L6.234 72.736a50.039 50.039 0 0 0 2.867 5.034ZM15.874 63.76c.033-1.58.17-3.14.403-4.667l13.634-3.06c-.077-.293-.15-.587-.214-.883L2.194 61.32a50.633 50.633 0 0 0 1.453 5.183l12.23-2.743h-.003ZM1.744 41.736l18.797 5.054a36.554 36.554 0 0 1 2.326-3.594l6.974 1.874c.04-.157.08-.31.123-.467l-27.223-7.32a50.033 50.033 0 0 0-.997 4.453ZM24.99 40.566c.86-.97 1.774-1.893 2.734-2.763l4.053 2.237c.064-.12.13-.24.197-.36L7.294 26.06a51.43 51.43 0 0 0-1.856 3.713l19.556 10.79-.003.003ZM30.08 35.836a36.62 36.62 0 0 1 2.884-1.993l1.917 1.77c.07-.08.143-.157.216-.237l-20.706-19.13c-.847.91-1.66 1.857-2.44 2.837l18.13 16.75v.003ZM20.918 10.35l14.56 22.066c.576-.296 1.16-.576 1.753-.843 0 0 1.07-.46 1.313-.56L23.644 8.43c-.93.61-1.836 1.25-2.726 1.92ZM41.014 30.126c.247-.076 1.81-.53 2.273-.643 0 0 .437-.107.557-.133l-9.35-26.297c-.92.327-1.83.677-2.73 1.057l9.25 26.02v-.004ZM46.634 28.85c.82-.177 1.65-.304 2.49-.387L46.314.413a51.56 51.56 0 0 0-2.496.31l2.82 28.123-.004.004ZM52.34 28.39c.7.036 1.4.103 2.1.206L58.42.686c-.696-.1-1.396-.186-2.093-.26l-3.99 27.96.004.004ZM469.061 75.434v-9.19h-3.158v-1.236h7.865v1.237h-3.158v9.19h-1.549ZM474.987 75.434V65.008h2.145l2.89 8.371 2.77-8.37h2.22v10.425h-1.564v-8.251l-2.771 8.251h-1.385l-2.741-8.251v8.251h-1.564Z'
    />
  </svg>
);
